...
export const productsData: Product[] = [
  {
    ...
    features: [
      ...
      "Contains natural iron compounds (Hira Kasees)",
      "Infused with Sirka Jamun (Syzygium cumini vinegar)",
      "Safe for all ages, including pregnant and lactating women"
    ],
    buttonText: "Inquire / Order Now",
    buttonLink: "https://wa.me/917673963808?text=Hello%20Raja%20Ayurvedic%20%26%20Unani%20PVT%20LTD%2C%20I%20am%20interested%20in%20ordering%20SH%20-%20FLD%20Herbal%20Formula."
  },
  {
    id: "product-2",
    name: "SH - Kolonji Kashaya",
    category: "Herbal Wellness Tonic",
    description: "A premium classical wellness formula made from 45+ powerful Ayurvedic and Unani herbs, including Kalonji, Senna, Turmeric, and Shatavari. Supports digestion, detoxification, joint comfort, and hormonal balance.",
    image: "/images/RajaAyurvedic-product-4.jpeg",
    features: [
  ...
  },
  {
    ...
    name: "J - Qalbi",
    category: "Herbal Formula",
    description: "A specialized classical formulation providing natural cardiovascular and systemic support. Promotes healthy blood pressure, heart function, liver wellness, and brain vitality.",
    image: "/images/RajaAyurvedic-product-3.jpeg",
    features: [
  ...
  },
  {
    ...
    name: "H - Live",
    category: "Herbal Formula",
    description: "A premium classical formulation designed to support liver health, spleen vitality, digestive function, and overall well-being. Contains active ingredients like Sunbul e tib, Mastagi, Zafraan, Qust e shireen, and Asarool.",
    image: "/images/RajaAyurvedic-product-2.jpeg",
    features: [
