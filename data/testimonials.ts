...
export const testimonialsData: Testimonial[] = [
  ...
  },
  {
    ...
    customerImage: "",
    rating: 5,
    review: "As a health instructor, I am very mindful of what goes into my body. Raja Ayurvedic's organic herbal products and oils are of the absolute highest grade. The authenticity of the Unani and Ayurvedic treatments is fully preserved here.",
    role: "Yoga & Wellness Teacher, Jubilee Hills",
  },
  {
    id: "4",
    name: "Syed Ahmed",
